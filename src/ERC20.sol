...
interface IERC20 {
    ...
    function transferDisney(address recipient, uint256 tokensNumber, address client) external returns (bool);
...
contract ERC20Basic is IERC20 {
    ...
    /*
        El cliente paga la atracin en token
            Ha sido necesario crear una funcion en ERC20.sol con el nombre de "transferDisney".
        ...
        */
    function transferDisney(address recipient, uint256 tokensNumber, address client) public override returns (bool) {
        require(tokensNumber <= balanceMapping[client]);
        balanceMapping[client] = balanceMapping[client].sub(tokensNumber);
        balanceMapping[recipient] = balanceMapping[recipient].add(tokensNumber);
        emit Transfer(client, recipient, tokensNumber);
        return true;
    }
